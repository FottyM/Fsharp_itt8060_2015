...
let fullRow (g: Game) : bool = 
    ...
    |[|_;_;_;_;_;_;Some a;Some b;Some c|] when a = b && b = c -> true
    |[|Some a;_;_;Some b;_;_;Some c;_;_|] when a = b && b = c -> true
    |[|_;Some a;_;_;Some b;_;_;Some c;_|] when a = b && b = c -> true
    |[|_;_;Some a;_;_;Some b;_;_;Some c|] when a = b && b = c -> true
    |[|Some a;_;_;_;Some b;_;_;_;Some c|]  when a = b && b = c -> true
    |[|_;_;Some a;_;Some b;_;Some c;_;_|]  when a = b && b = c -> true
...
// Should be implemented
let performMove (g: Game) (m: Move) : Game =  // NB! implementation missing
    let (value,index) = m
    Array.set g index  (Some value) 
    g
